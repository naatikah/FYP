...
$query = "SELECT * FROM payment p, booking b, user u, status s, offer o WHERE p.BookingID = b.BookingID AND u.UserID = p.UserID AND o.StatusID = s.StatusID AND o.BookingID = b.BookingID AND u.StatusID != 2 AND u.StatusID != 3";
