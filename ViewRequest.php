...
<body>
  ...
  <tbody>
      ...
      <?php if ($statusid=="6") { ?>
        ...
        <td> <a href="viewrequestdetails.php?id=<?php echo $bookingid;?>">View Details</a>
          <button class="btn btn-success" type="submit" onclick="offer()">Make Offer</button></td>
      

  <?php } else if ($statusid=="12") { ?>
        <td><?php echo $bookingid ?></td>
        <td><?php echo $user ?></td>
        <td><?php echo $district ?></td>
        <td><?php echo $startdate ?></td>
...
<?php }?>
      ...
      <!-- <tr>
          ...
          <td>6</td>
            <td>    
              <button class="btn btn-primary" type="submit" onclick="view()">View Details</button>

              <button class="btn btn-success" type="submit" onclick="offer()">Make Offer</button>
        ...
        <tr>
          ...
          <td>3</td>
            <td>    
              <button class="btn btn-primary" type="submit" onclick="review()">Make Review</button>
            </td>
