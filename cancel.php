...
<body>
    ...
    <div class="container">
    <h1>Your PayPal transaction has been cancelled.</h1>
        <form action="./viewoffer.php" id="bookform" method="post">
    <button class="btn btn-success" type="submit">Return back to View Offers</button> 
</form>
     </div>
     </div>
